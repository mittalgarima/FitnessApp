                    ...
                    >
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>HRX class</h1>
                        ...
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>Yoga class</h1>
                                <p className='text-sm p-2 text-center'>stias architecto voluptas repellendus. Sint aliquam veritatis ipsam autem beatae error modi cumque.</p>
                            </span>
                        </SwiperSlide>
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>Burn class</h1>
                                <p className='text-sm p-2 text-center'>stias architecto voluptas repellendus. Sint aliquam veritatis ipsam autem beatae error modi cumque.</p>
                            </span>
                        </SwiperSlide>
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>Stretching class</h1>
                                <p className='text-sm p-2 text-center'>stias architecto voluptas repellendus. Sint aliquam veritatis ipsam autem beatae error modi cumque.</p>
                            </span>
                        </SwiperSlide>
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>Boxing class</h1>
                                <p className='text-sm p-2 text-center'>stias architecto voluptas repellendus. Sint aliquam veritatis ipsam autem beatae error modi cumque.</p>
                            </span>
                        </SwiperSlide>
                        <SwiperSlide>
                            ...
                            <span className="flex gap-y-4 flex-col opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 justify-center items-center text-slate-700 bg-[#f5d0feda]">
                                <h1 className='text-sm font-bold uppercase'>Dance class</h1>
                                <p className='text-sm p-2 text-center'>stias architecto voluptas repellendus. Sint aliquam veritatis ipsam autem beatae error modi cumque.</p>
                            </span>
                        </SwiperSlide>
                    </Swiper>
